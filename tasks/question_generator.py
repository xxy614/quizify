...
class QuizGenerator:
    ...
    def generate_question_with_vectorstore(self):
        ...
        context_docs = self.vectorstore.query_chroma_collection(self.topic)
        ...
        setup_and_retrieval = RunnableParallel(
            {"context": RunnablePassthrough(), "topic": RunnablePassthrough()}
        )
        # Create a chain with the Retriever, PromptTemplate, and LLM
        chain = setup_and_retrieval | prompt | self.llm 

        # Invoke the chain with the topic and context as input
